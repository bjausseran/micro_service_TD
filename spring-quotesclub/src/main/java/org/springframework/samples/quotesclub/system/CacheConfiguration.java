...
package org.springframework.samples.quotesclub.system;
...
class CacheConfiguration {
	...
	@Bean
	public JCacheManagerCustomizer quotesclubCacheConfigurationCustomizer() {
		return cm -> {
			cm.createCache("quotes", cacheConfiguration());
		};
	}
